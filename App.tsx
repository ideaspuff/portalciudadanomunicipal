...
function App() {
  ...
  return (
    <div className={`min-h-screen ${PORTAL_THEME.colors.background} flex flex-col font-sans`}>
      ...
      {/* AI Assistant available except in immersive reading modes or auth */}
      {!['privacy', 'terms', 'auth', 'account'].includes(currentView) && (
          <AIAssistant onServiceRecommended={navigateToService} />
      )}
