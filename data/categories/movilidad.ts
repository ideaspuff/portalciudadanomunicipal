import { Ticket, TrafficCone, Ban, Signpost, Truck, Accessibility } from 'lucide-react';
...
export const movilidadServices: ServiceDefinition[] = [
  {
    id: 'multas',
    title: 'Gestión de Infracciones de Tránsito',
    description: 'Consulta, pago, solicitud de descuento o calificación de multas municipales.',
  ...
  },
  {
    ...
    title: 'Solicitud de Estacionamiento Exclusivo',
  ...
  {
    id: 'obstruccion_vial',
    title: 'Obstrucción de Cochera o Vía Pública',
    description: 'Solicitud de grúa para retirar vehículos que bloquean cocheras o rampas de discapacidad.',
    category: 'Tránsito y Vialidad',
    icon: Ban,
    sla: 'Inmediata',
    fields: [
